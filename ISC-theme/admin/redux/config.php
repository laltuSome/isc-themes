    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
              array(
                'id'       => 'footer-image',
                'type'     => 'media',
                'title'    => __( 'Footer Image', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Footer.', 'redux-framework-demo' ),
            ),
               array(
                'id'       => 'footer-yelp',
                'type'     => 'media',
                'title'    => __( 'yelp Image', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Footer.', 'redux-framework-demo' ),
            ),
                ...
                'id'       => 'footer-houzz',
                'type'     => 'media',
                'title'    => __( 'houzz Image', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Footer.', 'redux-framework-demo' ),
            ),
			...
			array(
                'id'       => 'footer-text',
                'type'     => 'textarea',
                'title'    => __( 'Content Text', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Content Text on your website.', 'redux-framework-demo' ),
            ),
    array(
                'id'       => 'url-book',
                'type'     => 'text',
                'title'    => __( 'book now url', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update url link  on your website.', 'redux-framework-demo' ),
            ),
